...
<head>
    ...
    <link href="C:\Users\ajayb\Desktop\Front_end_Cubix\Css\homepage_Css.css" rel="stylesheet">
...
*/
/* 
    Created on : Mar 30, 2023, 9:06:36 AM
    Author     : nitro 5
*/
    ...
    <div class="main_container">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="../CustomerPage/rentallisting.jsp">Rental Listing</a></li>
                <li><a href="#">Contact Us</a></li>
                <li><a href="#">About Us</a></li>
                <li><a href="login.jsp"><input type="submit" value="Login"></a></li>
                <li><a href="../CustomerPage/register.jsp"><input type="submit" value="Register"></a></li>
        ...
        <div class=home_page_image1>
            ...
            <img src="./CustomerPage/background.jpg" alt=" loading Image" width="100%" height="520px">
        ...
        <div class="first">
            ...
            <div class="about">
                <div  id="left" class="about_left">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam, voluptate aspernatur possimus similique sunt incidunt itaque dolorum magni? Inventore, nesciunt voluptatum sit deserunt doloribus quidem quia cupiditate in aperiam perferendis eveniet at iusto nulla rerum ex molestias temporibus illo. Nemo deserunt itaque possimus provident eum molestias perspiciatis, excepturi magni porro debitis harum praesentium, in cumque vitae voluptatum labore illum consequatur est aperiam a. Consequatur ratione officiis nam libero nesciunt itaque accusantium expedita vitae? Sed, quod libero unde voluptatem minima at veritatis iste aspernatur provident. Fuga laboriosam maiores dolorum quam expedita ipsum cum ullam ut! Dolorem voluptates, eaque eum sit beatae doloribus magnam facere corporis debitis sapiente. Nisi eum eos recusandae, deserunt delectus officiis quas assumenda. Velit quibusdam voluptatem placeat praesentium. Illum consequuntur qui libero. Debitis..</p>
                </div>
