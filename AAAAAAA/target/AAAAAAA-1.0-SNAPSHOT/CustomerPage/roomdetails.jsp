...
<body>
    ...
    <div class="title">
        <h2>Room Available(Ekantakuna, Kathmandu)</h2>
    </div>
    <div class="image">
        <img src="background.jpg" alt=" please check you internet connection">
    </div>
    <div class="title1">
        <h2>Details</h2>
    </div>
    <div class="title3">
        <div class="left" id="left" >
            ...
            <p>Location: Dhobighat, Kathmandu</p>
            <p>Size: 4/4 Squarefeet</p>
            <p>House Rule: </p>
            <p> i: Accepted both geneder</p>
